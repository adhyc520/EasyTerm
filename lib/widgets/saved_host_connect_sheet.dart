...
class SavedHostCredentials {
  const SavedHostCredentials({required this.password, this.privateKeyPem});
...
class _SavedHostConnectBodyState extends State<_SavedHostConnectBody> {
  ...
  Future<void> _submit() async {
    ...
    Navigator.of(
      context,
    ).pop(SavedHostCredentials(password: _password.text, privateKeyPem: pem));
  }
    ...
    return Padding(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text(
              l.savedHostConnectTitle(p.label),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                labelText: hasKey
                    ? l.savedHostPasswordFieldKey
                    : l.savedHostPasswordFieldPassword,
                helperText: hasKey
                    ? l.savedHostPasswordHelperKey
                    : l.savedHostPasswordHelperPassword,
              ),
              obscureText: true,
